...
RUN mkdir -p /var/log/noaa-marine-mcp-server && chown -R bun:bun /var/log/noaa-marine-mcp-server
...
ENV LOGS_DIR="/var/log/noaa-marine-mcp-server"
ENV MCP_FORCE_CONSOLE_LOGGING="true"

# Expose the port the server listens on
EXPOSE ${MCP_HTTP_PORT}

# Health check against /healthz (HTTP mode)
